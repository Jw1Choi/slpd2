			  ...
			  <form action="" id="form_e11" method="POST" target ="hidden_iframe11" onsubmit=" submitted=true;"> 
					<div class="wow fadeIn bbackg"> 
							 ...
							 <section  id="main_intro" class="backg" style="text-align: center;" >
								  ...
								  <img src="./img/ezgif-frame-041.jpg" class="bg-img br50" style="min-height:400px;max-height:600px">
							 
							  <div class="img-text" style="font-size:14px;">
							  <center><h1><span class="questm ft-white">-14kg 감량 프로젝트에 참여하세요.</span></h1></center><br>
							  ...
							  <label class="label_button1 " id="start" for="quest00_1" onclick="go_gw()"><span style="font-size: 16px;"></span><span >시작하기</span></label><Br>
						  ...
						  <!--질문 클릭 시 진행 방향 함수-->
							 ...
							 <!--질문 클릭 시 진행 방향 함수-->
							  ...
							  <center><input id="mf_1" name="entry.1818522882" type="radio" value="여성" /> <label class="label_button1" for="mf_1" onclick="jump_quest(7)" >여성</label></center>
						 ...
						 <section  id="quest4_wrap" class="wow fadeIn backg container1" >	
						  ...
						  <div class="wow fadeIn img-text ft-white">	
							  <center><h1><span class="questm ft-white">나이</span></h1></center>
										 ...
										 <label class="label_button1 disabled" id="next_age" for="quest4_1" style="text-align:Center;" onclick="go_name()">다음</label></center>	
										 </div>
